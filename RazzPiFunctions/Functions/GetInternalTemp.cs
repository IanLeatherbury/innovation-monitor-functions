...
{
    public static class GetInternalTemp
    {
        [FunctionName("GetInternalTemp")]
        public static async Task<HttpResponseMessage> Run([HttpTrigger(AuthorizationLevel.Function, "get", "post", Route = null)]HttpRequestMessage req, TraceWriter log)
        {
            log.Info("C# HTTP trigger function [GetInternalTemp] processed a request.");
            ...
            }))
            {
                try
                {
                    ...
                    var tempHumidity = CosmosDataService.Instance("InternalTempCollection").GetInternalTempModel();
